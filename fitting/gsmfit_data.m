function [fitstruct, message]= gsmfit_data(dataset, settings, modelfile)
...
%-- global fitting considers data groups separately. 
...
message= strjoin({message,'Global Single-Model Fit ended normally.'},'\n');
rmpath(mpath);
